...
export function buildSlideDeckPrompt(
  ...
  return [
    ...
    "## DECK RULES",
    "- 8-14 slides total.",
    "- Slide 1: just the title + a one-line subtitle that pre-frames the value.",
    "- Slide 2: the hook (verbatim or near-verbatim).",
    ...
    "- Bullets must be SHORT (max 8 words each). Use them only when they help; prefer body text for nuance.",
    "- Speaker notes: 1-3 sentences per slide reminding the user what they wanted to say (drawn from their answers).",
    "",
    "## OUTPUT FORMAT",
    'Return ONLY: { "slides": [{ "title": string, "bullets"?: string[], "body"?: string, "speakerNotes"?: string }, ...] }',
